...
| drive-search-modal | 드라이브 검색 모달 | active | 드라이브 검색 모달 | 검색 입력·드라이브 선택 | 내 드라이브·공유 드라이브 | 1depth 폴더 목록 | 기능정의_2-2차 | 드라이브 검색 모달 진입 구조.md · 키보드 포커스 및 단축키.md | 최초 화면에서 내 드라이브·공유 드라이브를 선택한 후 해당 드라이브의 폴더 목록으로 진입 |
