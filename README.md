...
팀이 제품을 만들면서 생기는 기준 문서, 회의록, 확정 결정, 기존 기능정의서를 모아 두는 곳입니다.
...
| `projects/{project}/xlsx/` | 기존 기능정의서 XLSX. AI가 기존 ID와 정책을 확인할 때 사용 |
...
- 기존 기능정의서 XLSX는 상세 기준입니다. 기능 ID, L10N ID, QA 기준과 충돌하지 않도록 AI가 참고합니다.
...
3. `xlsx/`의 기존 기능정의서에서 상세 ID와 정책 확인
